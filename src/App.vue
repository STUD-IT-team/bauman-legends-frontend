    ...
    <div class="root-technical-works">
      <main class="box">
        <div class="main-content">
          ...
          <article>В данный момент на сайте появляется что-то новое и классное. К сожалению, на это нужно время, зайдите сюда через год.</article>
          <br>
          <article>Все зарегистрированные команды сохранены, начать проходить квест можно в ГЗ 19 октября в ауд. 345 (читальный зал) <b>с <u>10:00</u> до <u>18:00</u></b>. Ярмарка будет работать <b>с <u>11:00</u> до <u>19:00</u></b>.</article>
          <article><small><i>И пусть удача всегда будет с вами.</i></small></article>
          <sub>
