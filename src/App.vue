    ...
    <div class="root-technical-works">
      <main class="box">
        <div class="main-content">
          ...
          <article>Все зарегистрированные команды сохранены, приходите в ГЗ 19 октября к ауд 345 (читальный зал) в 10:00.</article>
          <article>И пусть удача всегда будет с вами</article>
          <sub>
